...
<body class="bg-gradient-to-b from-white to-purple-50 min-h-screen">
    ...
    <div id="confirmation-modal" class="modal">
        <div class="bg-white rounded-xl shadow-2xl p-8 max-w-2xl w-full mx-4 transform transition-all">
            <h2 class="text-2xl font-bold text-gray-800 mb-4">Confirmar envío de ejercicio</h2>
            
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-700 mb-2">Resumen del ejercicio</h3>
                <div class="bg-gray-50 rounded-lg p-4 mb-4">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <span class="block text-sm text-gray-500">Puntos obtenidos</span>
                            <span id="modal-points" class="font-medium">-</span>
                        </div>
                        <div>
                            <span class="block text-sm text-gray-500">Tiempo empleado</span>
            ...
            <div class="flex justify-end space-x-4">
                <button id="cancel-submit" class="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-500">
                    Cancelar
                </button>
                <button id="confirm-submit" class="px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                    Enviar ejercicio
                </button>
            </div>
        </div>
